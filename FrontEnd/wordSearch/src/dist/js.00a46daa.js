...
var Grid = /*#__PURE__*/function () {
  function Grid() {
    ...
    this.wordSelectMode = false; // save cells that user select in array
  ...
  (0, _createClass2.default)(Grid, [{
    ...
    value: function renderGrid(gridSize, wordGrid) {
      ...
      var gridArea = document.getElementsByClassName("grid-area")[0]; //handle rendering multiple Grids
      ...
      tbl.addEventListener("mousedown", function (event) {
        ...
        var cell = event.target; // putting + to convert it to num
...
submitWordBtn.addEventListener("click", /*#__PURE__*/(0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee() {
  var grid, commaSeperetedWords, gridSize, result, wordListNode, wordListSection;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          commaSeperetedWords = document.querySelector("#add-word").value;
          gridSize = document.querySelector("#grid-size").value;
          _context.next = 6;
          return fetchGridinfo(gridSize, commaSeperetedWords);
...
function _fetchGridinfo() {
  _fetchGridinfo = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee2(gridSize, commaSeperetedWords) {
    var response, result;
    return _regenerator.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return fetch("http://localhost:8080//wordGrid?gridSize=".concat(gridSize, "&wordList=").concat(commaSeperetedWords));
